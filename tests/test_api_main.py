            ...
            module_path.write_text(
                "\n".join(
                    [
                        ...
                        "}",
                        "",
                        "def _load_transaction_rows(transformation_service, rows, run_id, source_name):",
                        ...
                        "                },",
                        "                count_existing=lambda transformation_service, run_id: transformation_service.count_transactions(run_id),",
