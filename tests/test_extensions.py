            ...
            module_path.write_text(
                "\n".join(
                    [
                        ...
                        "                build_runtime_service=lambda runtime: object(),",
                        '                get_run=lambda service, run_id: type("Run", (), {',
                        '                    "passed": True,',
                        '                    "status": type("Status", (), {"value": "passed"})(),',
                        '                    "header": ["planned_amount"],',
                        '                    "source_name": "custom-source",',
                        "                })(),",
                        '                get_canonical_rows=lambda service, run_id: [{"planned_amount": "12.50"}],',
                        "                serialize_row=lambda row: row,",
                        "                count_existing=lambda transformation_service, run_id: 0,",
                        "                load_rows=lambda transformation_service, rows, run_id, source_name: len(rows),",
                        "            ),",
                        "        )",
                        "    )",
                    ]
