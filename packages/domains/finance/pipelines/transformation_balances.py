...
from packages.domains.finance.pipelines.balance_models import (
...
from packages.domains.finance.pipelines.transaction_models import FACT_TRANSACTION_CURRENT_TABLE
