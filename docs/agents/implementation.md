...
- Confirm that any existing exclusive claim either belongs to the current workspace or has been handed off before editing repo files.
...
- Stop if a sprint-scoped item has an exclusive claim that does not clearly belong to the current workspace and no handoff has been produced.
