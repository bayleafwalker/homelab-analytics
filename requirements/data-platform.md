...
| PLT-18 | Canonical data flow | `packages/pipelines/promotion.py`, `packages/pipelines/promotion_types.py`, `packages/pipelines/builtin_promotion_handlers.py`, `packages/pipelines/account_transaction_service.py`, `packages/pipelines/subscription_service.py`, `packages/pipelines/contract_price_service.py`, `packages/storage/landing_service.py`, `packages/storage/ingestion_config.py`, `apps/api/app.py`, `apps/worker/main.py` | `tests/test_promotion.py`, `tests/test_subscription_domain.py`, `tests/test_contract_price_domain.py`, `tests/test_api_app.py`, `tests/test_worker_cli.py` |
