...
| APP-04 | `apps/api/app.py`, `apps/api/support.py`, `apps/api/runtime_state.py`, `apps/api/routes/auth_routes.py`, `apps/api/routes/config_routes.py`, `apps/api/routes/control_routes.py`, `apps/api/routes/ingest_routes.py` | `tests/test_api_app.py` |
