...
| APP-03 | `apps/api/app.py`, `apps/api/support.py`, `apps/api/routes/report_routes.py` | `tests/test_api_app.py`, `tests/test_utility_domain.py`, `tests/test_local_domain_harness.py` |
| APP-04 | `apps/api/app.py`, `apps/api/support.py`, `apps/api/routes/auth_routes.py`, `apps/api/routes/config_routes.py`, `apps/api/routes/control_routes.py`, `apps/api/routes/ingest_routes.py` | `tests/test_api_app.py` |
...
| APP-12 | `apps/api/app.py`, `apps/api/support.py`, `apps/web/frontend/app/health/route.js` | `tests/test_api_app.py`, `tests/test_web_app.py` |
