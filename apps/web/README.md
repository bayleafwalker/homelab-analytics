...
- the current UI surface now includes dashboard, reports, filterable run history, run detail with lineage/publication drill-down, operator-facing manual uploads, auth/security admin, source catalog edit/deactivate flows, dataset-contract and mapping version management, mapping preview, and execution-control schedule/queue actions
