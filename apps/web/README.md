...
- the current UI surface now includes dashboard, reports, filterable run history, run detail with lineage/publication drill-down, auth/security admin, source catalog edit/deactivate flows, and execution-control schedule/queue actions
