...
export const publicationContractMap = {
  ...
  "mart_asset_value": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Asset Value",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_asset_value",
    "relation_name": "mart_asset_value",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_asset_value",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_automation_reliability": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Automation Reliability",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_automation_reliability",
    "relation_name": "mart_automation_reliability",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_automation_reliability",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_climate_summary": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Climate Summary",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_climate_summary",
    "relation_name": "mart_climate_summary",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_climate_summary",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_cluster_utilization": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Cluster Utilization",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_cluster_utilization",
    "relation_name": "mart_cluster_utilization",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_cluster_utilization",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_debt_overview": {
    ...
    "columns": [
      ...
      {
        "aggregation": "pct_change",
        "description": "Share of total pct",
        "filterable": false,
        "grain": null,
        "json_type": "string",
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Debt Overview",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_debt_overview",
    "relation_name": "mart_debt_overview",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_debt_overview",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_depreciation_schedule": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Depreciation Schedule",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_depreciation_schedule",
    "relation_name": "mart_depreciation_schedule",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_depreciation_schedule",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_device_battery": {
    ...
    "columns": [
      ...
      },
      {
        ...
        "semantic_role": "measure",
        "sortable": true,
        "storage_type": "DECIMAL(6,2) NOT NULL",
        "unit": "percent"
      },
      {
        "aggregation": null,
      ...
      {
        "aggregation": "avg",
        "description": "Avg daily drain pct",
        "filterable": false,
        "grain": null,
        "json_type": "string",
        "name": "avg_daily_drain_pct",
        "nullable": true,
        "semantic_role": "measure",
        "sortable": true,
      ...
      {
        "aggregation": "none",
        "description": "Est days to empty",
        "filterable": false,
        "grain": null,
        "json_type": "number",
        "name": "est_days_to_empty",
        "nullable": true,
        "semantic_role": "measure",
        "sortable": true,
        "storage_type": "INTEGER",
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Device Battery",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_device_battery",
    "relation_name": "mart_device_battery",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_device_battery",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_energy_daily": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Energy Daily",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_energy_daily",
    "relation_name": "mart_energy_daily",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_energy_daily",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_infra_cost": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Infra Cost",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_infra_cost",
    "relation_name": "mart_infra_cost",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_infra_cost",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_subscription_changes": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Subscription Changes",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_subscription_changes",
    "relation_name": "mart_subscription_changes",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_subscription_changes",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
  ...
  "mart_uptime_summary": {
    ...
    "confidence_verdict": null,
    "description": null,
    "display_name": "Mart Uptime Summary",
    "freshness_state": null,
    "lineage_required": true,
    "pack_name": null,
    "pack_version": null,
    "publication_key": "mart_uptime_summary",
    "relation_name": "mart_uptime_summary",
    "renderer_hints": {},
    "retention_policy": "indefinite",
    "schema_name": "mart_uptime_summary",
    "schema_version": "1.0.0",
    "supported_renderers": [
      "web"
    ],
