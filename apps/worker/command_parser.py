...
def build_parser() -> argparse.ArgumentParser:
    ...
    registry_sources_parser = subparsers.add_parser("list-extension-registry-sources")
    registry_sources_parser.add_argument("--include-archived", action="store_true")
    registry_revisions_parser = subparsers.add_parser("list-extension-registry-revisions")
    registry_revisions_parser.add_argument("--source-id", default="")
    subparsers.add_parser("list-extension-registry-activations")
    transformation_packages_parser = subparsers.add_parser("list-transformation-packages")
    transformation_packages_parser.add_argument("--include-archived", action="store_true")
    publication_definitions_parser = subparsers.add_parser("list-publication-definitions")
    publication_definitions_parser.add_argument("--transformation-package-id", default="")
    publication_definitions_parser.add_argument("--include-archived", action="store_true")
    subparsers.add_parser("list-transformation-handlers")
    subparsers.add_parser("list-publication-keys")
    sync_registry_source_parser = subparsers.add_parser("sync-extension-registry-source")
    sync_registry_source_parser.add_argument("source_id")
    sync_registry_source_parser.add_argument("--activate", action="store_true")
    ...
    subparsers.add_parser("list-functions")
