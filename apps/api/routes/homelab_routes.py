...
def register_homelab_routes(
    ...
    *,
    ...
    async def get_service_health() -> dict[str, Any]:
        ...
        rows = transformation_service.get_service_health_current()
    ...
    async def get_backup_freshness() -> dict[str, Any]:
        ...
        rows = transformation_service.get_backup_freshness()
        return {"rows": to_jsonable(rows)}
    ...
    async def get_storage_risk() -> dict[str, Any]:
        ...
        rows = transformation_service.get_storage_risk()
        return {"rows": to_jsonable(rows)}
    ...
    async def get_workload_cost_7d() -> dict[str, Any]:
        ...
        rows = transformation_service.get_workload_cost_7d()
        return {"rows": to_jsonable(rows)}
